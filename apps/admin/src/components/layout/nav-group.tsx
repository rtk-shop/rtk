...
import { NavCollapsible, NavItem, NavLink, type NavGroup } from './data/sidebar-data'
...
const SidebarMenuCollapsedDropdown = ({ href, item }: { item: NavCollapsible; href: string }) => {
  return (
    <SidebarMenuItem>
      <DropdownMenu>
