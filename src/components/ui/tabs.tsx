...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10.5 items-center justify-center rounded-xl bg-gray-100 px-1 text-gray-500',
      className
    )}
    {...props}
  />
